...
export const openAiTextResponse = (resText: string, jobStatus?: JobStatus) => {
  return {
    response: {
      aiServiceResponse: {
        aiAllStepsData: [
