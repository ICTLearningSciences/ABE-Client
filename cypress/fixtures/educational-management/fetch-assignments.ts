...
export const testAssignment: Assignment = {
  ...
  description:
    "A quiz covering basic programming concepts including variables, loops, and functions.",
...
export const testAssignment2: Assignment = {
  ...
  description:
    "Implement various data structures in your chosen programming language.",
