...
export const generationsInProgressDocVersions: IGDocVersion[] = [
  {
...
export const generationCompleted: DehydratedGQLDocumentTimeline = {
    docId: '1LqProM_kIFbMbMfZKzvlgaFNl5ii6z5xwyAsQZ0U87Y',
    user: '653972706e601e65dbc3acea',
    timelinePoints: [
      {
...
export const generationsCompletedDocVersions: IGDocVersion[] = [
  {
    _id: '1LqProM_kIFbMbMfZKzvlgaFNl5ii6z5xwyAsQZ0U87Y',
    docId: '1LqProM_kIFbMbMfZKzvlgaFNl5ii6z5xwyAsQZ0U87Y',
    plainText: 'Hello, world! What’s going on ? I’m making more changes\n',
