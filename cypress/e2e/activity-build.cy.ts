...
export function flowIsEditable(cy: CypressGlobal) {
  ...
  cy.get("[data-cy=input-field-Flow-Title]").should(
    "contain.text",
    "New Flow Title",
  );
}
...
describe("activity builder", () => {
  describe("admins", () => {
    it("can edit all activities, despite ownership", () => {
      ...
      flowIsEditable(cy);
      cy.get("[data-cy=return-to-activity-list]").click();
      cy.get("[data-cy=activity-item-other-user-editable-activity]").should(
        "exist",
      );
      cy.get(
        "[data-cy=activity-item-edit-other-user-editable-activity]",
      ).click();
      flowIsEditable(cy);
      cy.get("[data-cy=return-to-activity-list]").click();
      cy.get("[data-cy=activity-item-other-user-read-only-activity]").should(
        "exist",
      );
      cy.get(
        "[data-cy=activity-item-edit-other-user-read-only-activity]",
      ).click();
      flowIsEditable(cy);
    });
    ...
    it("can delete any activity", () => {
      cyMockDefault(cy, {
        userRole: "ADMIN",
        gqlQueries: [
          mockGQL("FetchBuiltActivities", [
            fetchBuiltActivitiesResponse,
            {
              fetchBuiltActivities:
                fetchBuiltActivitiesResponse.fetchBuiltActivities.filter(
                  (a) => !["my-editable-activity"].includes(a._id),
                ),
            },
            {
              fetchBuiltActivities:
      ...
      cy.get("[data-cy=activity-item-my-editable-activity]").should(
        "not.exist",
      );
      ...
      cy.get(
        "[data-cy=activity-item-delete-other-user-editable-activity]",
      ).click();
      cy.get("[data-cy=two-option-dialog]").should("exist");
      cy.get("[data-cy=option-2]").click();
      cy.get("[data-cy=activity-item-other-user-editable-activity]").should(
      ...
      cy.get(
        "[data-cy=activity-item-delete-other-user-read-only-activity]",
      ).click();
      cy.get("[data-cy=two-option-dialog]").should("exist");
      cy.get("[data-cy=option-2]").click();
      cy.get("[data-cy=activity-item-other-user-read-only-activity]").should(
  ...
  describe("content managers", () => {
    ...
    it("can edit their own activities", () => {
      ...
      cy.get("[data-cy=return-to-activity-list]").click();
      cy.get("[data-cy=activity-item-my-read-only-activity]").should("exist");
      cy.get("[data-cy=activity-item-edit-my-read-only-activity]")
        .should("exist")
        .click();
      flowIsEditable(cy);
      cy.get("[data-cy=return-to-activity-list]").click();
      cy.get("[data-cy=activity-item-my-private-activity]").should("exist");
      cy.get("[data-cy=activity-item-edit-my-private-activity]")
        .should("exist")
        .click();
      flowIsEditable(cy);
      cy.get("[data-cy=return-to-activity-list]").click();
    ...
    it("can edit other users 'editable' set activities", () => {
      ...
      cy.get("[data-cy=activity-item-edit-other-user-editable-activity]")
        .should("exist")
        .click();
      flowIsEditable(cy);
      cy.get("[data-cy=return-to-activity-list]").click();
    ...
    it("cannot edit other users read-only activities", () => {
      ...
      cy.get("[data-cy=activity-item-edit-other-user-read-only-activity]")
        .should("exist")
        .click();
  ...
  describe("admins and content managers", () => {
    it("can copy activities", () => {
      ...
      cy.get(
        "[data-cy=activity-item-copy-other-user-read-only-activity]",
      ).click();
