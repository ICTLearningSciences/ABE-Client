...
export function useWithEciActivity(
  ...
  const [activityPrompts, setActivityPrompts] = useState<EciActivityPrompts>();
  ...
  const INITIATE_INTERPRETATION_DISCUSSION_PROMPT_ID =
    '6671e7e15e3bc37363ee2fe4';
  const COMPARE_DOCUMENT_CONTENT_PROMPT_ID = '6671e7eb5e3bc37363ee3055';
  const INITIATE_DOCUMENT_CONTENT_DISCUSSION_PROMPT_ID =
    '6671e7f45e3bc37363ee30c8';
  ...
  function getStep(stepData: StepData): ActiveActivityStep {
    ...
    switch (state.curStepName) {
      ...
      case EciStepNames.REVIEW_DOCUMENT_CONTENT:
        return startReviewDocumentContent(
          stepData,
          getMessage,
          state,
          setState,
      ...
      case EciStepNames.PICK_QUESTION_ABOUT_INTERPRETATION:
        return pickQuestionAboutInterpretation(
          stepData,
          getMessage,
          state,
          setState,
  ...
  function shouldWeReviewUnderstanding(stepData: StepData): ActiveActivityStep {
    ...
    return {
      text:
        reviewUnderstandingMessage ||
        "Would you like to review your understanding of the Commander's Intent?",
